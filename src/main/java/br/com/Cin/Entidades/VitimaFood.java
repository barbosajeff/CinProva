 ...
 */
@Entity
public class VitimaFood implements Serializable {
   ...
   private static final long serialVersionUID = 1L;
    ...
    public VitimaFood(Long id, String nomeCompleto, String eMail, String telefone, Endereco endereco) {
        this.id = id;
    ...
    public VitimaFood(String nomeCompleto, String eMail, String telefone, Endereco endereco) {
        this.nomeCompleto = nomeCompleto;
        this.eMail = eMail;
        this.telefone = telefone;
        this.endereco = endereco;
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + Objects.hashCode(this.nomeCompleto);
    ...
    public boolean equals(Object obj) {
        ...
        final VitimaFood other = (VitimaFood) obj;
